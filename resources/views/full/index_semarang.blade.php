    ...
    @else
        <script>
            ...
            function wsBarrierGate(WB = null) {
                ...
                if (WB == 'WB2' || WB == 'WB1') {
                    svgExample = "{{ asset('img/svg/barrier-gate-reverse-semarang.svg') }}";
                } else {
                    svgExample = "{{ asset('img/svg/barrier-gate-semarang.svg') }}";
                }
                scadavisInit({
                    container: 'bg-svg',
                    ...
                    ws.onmessage = function(e) {
                        ...
                        sv.storeValue("@manuver1862", parseFloat(data.manuver1862));
                        sv.updateValues();
                    }
